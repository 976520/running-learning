...
data = {
    '날짜': ['07월 30일', '07월 31일', '08월 01일', '08월 02일', '08월 03일', '08월 04일', '08월 05일', '08월 06일'],
    '뛴 거리 (km)': [5.33, 5.12, 6.0, 5.36, 5.02, 4.55, 5.0, 5.0],
    '평균 페이스': ["6'25''", "5'09''", "5'07''", "4'55''", "5'01''", "6'40''", "4'50''", "4'53''"],
    '뛴 시간': ["34분 09초", "26분 20초", "30분 41초", "26분 19초", "25분 09초", "30분 19초", "24분 10초","24분 26초"],
    '소모된 칼로리': [368, 383, 445, 404, 377, 313, 376, 376]
}
